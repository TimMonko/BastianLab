...
file_directory = r"C:\Users\TimMonko\Documents\GitHub\BastianLab\WorkingPython\AxonMitoMotility_TM 2"
...
for file in filenames:
    ...
    melt_data = (raw_data.melt(value_name = val_name, var_name = 'Tx'))
